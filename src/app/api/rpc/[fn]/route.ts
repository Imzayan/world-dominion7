...
const SHOP_PACKS = [
  /* PriceSync-v2: قیمت‌های نهایی ثبت‌شده در پنل مایکت — ۱۰۰جم=۳۰٬۰۰۰ / ۳۰۰جم=۸۵٬۰۰۰ / ۵۵۰جم=۱۵۰٬۰۰۰ / ۱۰۰۰جم=۳۰۰٬۰۰۰ تومان.
     نرخ هر جم: ۳۰۰ / ۲۸۳ / ۲۷۳ / ۳۰۰ (بسته‌ی ۵۵۰ جم بهترین نرخ را دارد). کاتالوگ سمت سرور تنها مرجع قیمت است؛ کلاینت فقط نمایش می‌دهد. */
  { id: 'gems_100', gems: 100, price: '۳۰٬۰۰۰ تومان', perGem: '۳۰۰', name: 'شروع', tier: '', url: '' },
  { id: 'gems_300', gems: 300, price: '۸۵٬۰۰۰ تومان', perGem: '۲۸۳', name: 'جنگاور', tier: '', url: '' },
  { id: 'gems_550', gems: 550, price: '۱۵۰٬۰۰۰ تومان', perGem: '۲۷۳', name: 'فاتح', tier: '', url: '' },
  { id: 'gems_1000', gems: 1000, price: '۳۰۰٬۰۰۰ تومان', perGem: '۳۰۰', name: 'امپراتور', tier: '', url: '' },
]
