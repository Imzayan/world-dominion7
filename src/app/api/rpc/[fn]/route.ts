...
const SHOP_PACKS = [
  /* PriceSync-300: هر جم ۳۰۰ تومان — هماهنگ با قیمت‌های ثبت‌شده در پنل مایکت (gems_100=۳۰٬۰۰۰ … gems_1000=۳۰۰٬۰۰۰).
     کاتالوگ سمت سرور تنها مرجع قیمت است؛ کلاینت فقط نمایش می‌دهد. */
  { id: 'gems_100', gems: 100, price: '۳۰٬۰۰۰ تومان', perGem: '۳۰۰', name: 'شروع', tier: '', url: '' },
  { id: 'gems_300', gems: 300, price: '۹۰٬۰۰۰ تومان', perGem: '۳۰۰', name: 'جنگاور', tier: '', url: '' },
  { id: 'gems_550', gems: 550, price: '۱۶۵٬۰۰۰ تومان', perGem: '۳۰۰', name: 'فاتح', tier: '', url: '' },
