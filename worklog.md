...
---
Task ID: shop-pricesync-300
Agent: main
Task: هماهنگ‌سازی قیمت پک‌های جم با قیمت‌گذاری ثبت‌شده در پنل مایکت (هر جم ۳۰۰ تومان)

Work Log:
- کاربر اعلام کرد قیمت هر جم را ۳۰۰ تومان حساب و در مایکت ثبت کرده است
- کاتالوگ مرجع سرور SHOP_PACKS در src/app/api/rpc/[fn]/route.ts (خط ۱۲۰-۱۲۵) به‌روز شد: gems_100=۳۰٬۰۰۰ / gems_300=۹۰٬۰۰۰ / gems_550=۱۶۵٬۰۰۰ / gems_1000=۳۰۰٬۰۰۰ تومان، perGem=۳۰۰
- کپی نمایشی کلاینت SHOP.packs در public/game/index.html (خط ۲۲۷۰-۲۲۷۵) هماهنگ شد
- برچسب‌های گمراه‌کننده «ارزش خرید/بهترین ارزش» حذف شدند — با نرخ ثابت همه پک‌ها ارزش یکسان دارند (قانون شفافیت)
- grep کل پروژه: هیچ قیمت قدیمی (۹۹٬۰۰۰/۲۶۹٬۰۰۰/۴۴۹٬۰۰۰/۶۹۹٬۰۰۰) باقی نمانده
- اسکریپت verify: client 4/4 + server 4/4 مطابق نرخ ۳۰۰
- commit 3ffcbdf و push به main (dfceee8..3ffcbdf) → دیپلوی Vercel

Stage Summary:
- شناسه‌های SKU مایکت بدون تغییر: gems_100 / gems_300 / gems_550 / gems_1000 (۱:۱ با کاتالوگ سرور)
- Server Authority دست‌نخورده: قیمت از SHOP_PACKS سمت سرور می‌آید؛ کلاینت فقط نمایش می‌دهد
- یادداشت برای Shop V2: اگر بعداً بونوس پلکانی (BEST VALUE) خواسته شود، تعداد جم تحویلی باید با محصول ثبت‌شده در مایکت مطابق باشد (نیاز به ویرایش محصولات پنل)

---
Task ID: shop-pricesync-v2
Agent: main
Task: اعمال قیمت‌های نهایی ثبت‌شده در پنل مایکت روی کاتالوگ جم (اصلاح نسخه قبل)

Work Log:
- کاربر قیمت‌های نهایی پنل مایکت را اعلام کرد: ۱۰۰جم=۳۰٬۰۰۰ / ۳۰۰جم=۸۵٬۰۰۰ / ۵۵۰جم=۱۵۰٬۰۰۰ / ۱۰۰۰جم=۳۰۰٬۰۰۰ تومان
- SHOP_PACKS سرور (route.ts:122-125) و SHOP.packs کلاینت (index.html:2271-2274) به‌روز شدند؛ perGem دقیق: ۳۰۰/۲۸۳/۲۷۳/۳۰۰
- verify خودکار: client 4/4 + server 4/4 + هیچ قیمت میانی قدیمی (۹۰/۱۶۵ هزار) باقی نمانده
- commit ad7808f و push به main → دیپلوی Vercel
